...
import { API } from "@/services/api"; // Loyihangizdagi axios instansi
...
export default function LearningCenterDetailView() {
            ...
            <div className="space-y-6 animate-pulse">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div className="lg:col-span-2 space-y-6">
                        <div className="h-44 bg-slate-50 dark:bg-slate-900/50 rounded-2xl border border-slate-100 dark:border-slate-800" />
                        <div className="h-32 bg-slate-50 dark:bg-slate-900/50 rounded-2xl border border-slate-100 dark:border-slate-800" />
                    </div>
                    <div className="h-72 bg-slate-50 dark:bg-slate-900/50 rounded-2xl border border-slate-100 dark:border-slate-800" />
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="space-y-6 animate-fade-in">
            ...
            {/* 2. Tezkor Statistika Vidjetlari (Mini Cards) */}
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="bg-white dark:bg-slate-900 p-4 border border-slate-200/60 dark:border-slate-800/80 rounded-2xl flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-base font-bold text-slate-900 dark:text-white mt-0.5">{data.students_count}</p>
                    </div>
                </div>
                ...
                <div className="bg-white dark:bg-slate-900 p-4 border border-slate-200/60 dark:border-slate-800/80 rounded-2xl flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-base font-bold text-slate-900 dark:text-white mt-0.5">{data.teachers_count}</p>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                {/* CHAP BLOK: Markaz Profili va Direktori */}
                <div className="lg:col-span-2 space-y-6">

                    {/* Markaz Asosiy Ma'lumotlari */}
                    <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200/60 dark:border-slate-800/80 space-y-6">
                        <div className="flex flex-col sm:flex-row sm:items-center gap-4 pb-5 border-b border-slate-100 dark:border-slate-800/60">
                            <div className="w-16 h-16 rounded-2xl bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 flex items-center justify-center overflow-hidden shrink-0 shadow-2xs">
                                {logoUrl ? (
                    ...
                    <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200/60 dark:border-slate-800/80">
                ...
                <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200/60 dark:border-slate-800/80 space-y-5 h-fit">
