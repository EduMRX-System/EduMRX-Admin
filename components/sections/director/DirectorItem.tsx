            ...
            <tr className="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors group">
                ...
                <td className="py-4 px-5">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <div className="font-semibold text-slate-900 dark:text-slate-100 leading-tight">{director.full_name}</div>
                            <div className="text-[11px] text-slate-400 dark:text-slate-500 mt-0.5 font-mono">ID: {director.id.slice(0, 8)}...</div>
                        </div>
                    </div>
                </td>
        ...
        <div className="bg-white dark:bg-slate-900 rounded-xl shadow-xs border border-slate-100 dark:border-slate-800 p-5 flex flex-col justify-between hover:shadow-md transition-all group">
            <div>
                <div className="flex items-center gap-3.5 mb-4">
                    ...
                    <div>
                        <h4 className="font-bold text-slate-900 dark:text-slate-100 text-base line-clamp-1">{director.full_name}</h4>
